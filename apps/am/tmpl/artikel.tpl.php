        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php if (hasPermissionPDO($mis_connPDO, $activemenuitem['id'], 'INSERT')) { ?>
                    <a disabled data-toggle="modal" href="apps/<?php echo app_name; ?>/modals/artikel.php?action=new"
                ...
                <table id="mainTable" class="table table-bordered table-striped dataTable">
                    ...
                    foreach ($Artikelen as $item) {
                        echo '<tr class="clickable-row" id =' . $item->artikelcode . ' naam ="' . $item->artikelcode . '">
                            <td>' . $count . '</td>
                            <td>' . $item->artikelcode . '</td>
                            <td>' . $item->artikelnaam . '</td>
							<td>' . $item->hulpstuk . '</td>
							<td>' . $item->minvoorraad . '</td>
                          </tr>';
                        $count++;
                    }
                    ?>
