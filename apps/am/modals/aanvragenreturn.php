...
$aanvragenpartsrecord = Aanvragenparts::where("aanvraagnr", "=", $_GET['id'])->orderBy('serienr', 'asc')->get();
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group ">
                    <label class="control-label requiredField" for="opmerking"> Check serialno for return </label>
                    <?php
                    $idx = 0;
                    foreach ($aanvragenpartsrecord as $r) {
                        $idx++;
                        ?>
                        <br><span><?php echo $r->serienr; ?> <input type="checkbox" name="returnpart[]" value="<?php echo $r->aanvpartnr; ?>"></span>
                        <?php
                    }
                    ?>
                </div>
