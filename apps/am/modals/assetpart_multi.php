...
$artikelrecord = Artikel::whereRaw('(hulpstuk <> "J" or hulpstuk is null)')->get();
...
<form action="apps/<?php echo app_name; ?>/assetpart.php?action=<?php echo $_GET['action']; ?>&recordId=<?php echo $_GET['id']; ?>"
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div>
                        <input disabled class="form-control" id="aantal" type="text" name="aantal"
        ...
        <div class="row" id="multirec_serie">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label" for="serienrmulti"> Serialnr </label>
                    <div class="input_fields_wrap">
                        <div class="col-md-6"><input type="text" name="serienrmulti[]" onblur="trimInputFields();"/>
                            <button type="button" class="btn btn-default add_field_button"><i class="fa fa-plus"></i>
                            </button>
                            <span class="asteriskField" style="color: red;" name="serienrcheck[]"></span></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(add_button).click(function (e) { //on add input button click
        ...
        if (x < max_fields) { //max input box allowed
            ...
            $(wrapper).append('<div class="col-md-6"><input type="text" name="serienrmulti[]" onblur="trimInputFields();" /><a href="#" class="remove_field"><button type="button" class="btn btn-default removeButton"><i class="fa fa-minus"></i></button><span class="asteriskField" style="color: red;" name="serienrcheck[]"></span></a></div>'); //add input box
        }
    });
