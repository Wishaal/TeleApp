		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					...
					<small> Main</small>
					<button class="btn btn-primary btn-sm" type="button" data-toggle="modal" data-target="#woningModal"> Woning Reserveren</button>
				</h1>
				...
				<div class="row">
					<div class="col-md-6">
							...
							<div class="nav-tabs-custom">
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab_1" data-toggle="tab">CAO Reserveringen</a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_1">
										<table id="table1" class="table table-bordered table-striped dataTable">
                                            ...
                                            $reserveringen = getReserveringenCAO($db);
											...
											<td>
											 <a href="apps/woningen/administratie-cao.php?action=annulering&id=' . $item['id'] . '" class="btn btn-warning btn-sm">Annuleren</a>
											</td>
										</tr>';
									...
									<div class="tab-pane" id="tab_2">
										<table id="table2" class="table table-bordered table-striped dataTable">
											...
											<tbody>
											<?php
                                            $wachtlijsInfos = getWachtlijstInfosCAO($db);
											...
											<td>' . $item['description'] . '</td>
											<td>
											 <a href="apps/woningen/administratie-cao.php?action=annuleringWachtlijst&id=' . $item['id'] . '" class="btn btn-warning btn-sm">Annuleren</a>
											</td>
										</tr>';
											}
											?>
					...
					<div class="col-md-6">
						<div class="box box-primary">
							<div class="box-body">
								<!-- THE CALENDAR -->
								<div id="calendar" class="fc fc-ltr fc-unthemed"><div class="fc-toolbar"></div></div>
							</div>
							<!-- /.box-body -->
						</div>
						<!-- /. box -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#calendar').fullCalendar({
				...
				events: 'http://teleapp/telesur_mis/apps/woningen/jsonCao.php'
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="daterange" id ="daterange" data-date-format="yyyy-mm-dd" class="form-control" value="<?php echo $_POST['daterange'];?>" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class=" selectpicker form-control" id="badgenr" name="badgenr" data-live-search="true" required="required">
...
select cast(id as varchar) as id ,name from woningenVerhuur..externe_gegevens");
								...
								<?php if($wachtlijst == 1){ ?>
									<div class="form-group">
										<label class="col-sm-12 control-label"
											   for="Woning">Wilt u op de Wachtlijst staan voor <br><?php echo $messageWachtlijst;?> ?</label class="col-sm-2 control-label">
									</div>
									<div class="form-group">
							...
							<div class="col-md-6">
								<div id="image-zoom">
									<img class="img-thumbnail zoom" src="" alt="A.u.b. woning opnieuw kiezen om foto te bezichten">
								</div>
							</div>
						</div>
						<div class="row">
	...
	<script type="text/javascript">
        $(function() {
            $('input[name="daterange"]').daterangepicker({
                ...
                ,
                isInvalidDate: function(date) { return (date.day() == 4) ? true : false; }
            });
        });
	</script>
                ...
                $.ajax({
                    ...
                    success: function (message) {
                        ...
                        if (message['status'].length === 0) {
                            ...
                            $(location).attr('href', 'apps/woningen/administratie-cao.php');
                        }
