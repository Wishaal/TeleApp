...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <a class="btn btn-default" href="apps/woningen/externe.reserveringen.php?action=new">
                                ...
                                foreach ($data as $item) {
                                    ...
                                    echo '<tr> 
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                             <li><a href="apps/woningen/externe.reserveringen.php?action=edit&amp;id=' . $item['id'] . '" class="icon edit">EDIT</a></li>
											 <li><a href="apps/woningen/externe.reserveringen.php?action=delete&amp;id=' . $item['id'] . '" class="icon delete">DELETE</a></li>
                                            </ul>
                                        </div>
											</td>
										</tr>';
