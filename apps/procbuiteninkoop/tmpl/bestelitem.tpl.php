    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom animated bounceInRight">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1-1" data-toggle="tab">Aanvragen</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1-1">
                    ...
                    <?php if (getInkoopPermisson('Voorbereider')) { ?>
                        <a data-toggle="modal" href="apps/<?php echo app_name; ?>/modals/bestelling.php?action=new"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#mainTable tr').click(function (event) {
                ...
                $('.inputDisabled').attr('href', "apps/<?php echo app_name;?>/modals/bestelling.php?action=update&id=" + $(this).attr('id'));

                $('.inputDisabledDelete').prop("disabled", false); // Element(s) are now enabled.
                $('.inputDisabledDelete').attr('data-href', "apps/<?php echo app_name;?>/bestelling.php?action=delete&id=" + $(this).attr('id'));
