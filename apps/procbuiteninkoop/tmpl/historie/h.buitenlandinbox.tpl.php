    ...
    <section class="content">
        ...
        <div class="box animated bounceInRight">
            <div class="box-header with-border">
                <h3 class="box-title">Buitenland Inbox Aanvragen </h3>
            </div>
            <div class="box-body">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#mainTable tr').click(function (event) {
                ...
                $('.inputDisabled').attr('href', "apps/<?php echo app_name;?>/modals/historie/buitenlandinbox.php?action=update&id=" + $(this).attr('id'));
