    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom animated bounceInRight">
            <ul class="nav nav-tabs">
                ...
                <li class="pull-left header"><i class="fa fa-th"></i> Buitenlandse Aanvragen | Shipping & BO Informatie
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1-1">
                    ...
                    <table id="mainTable" class="table table-bordered table-striped dataTable">
                        ...
                        foreach ($buiten as $r) {
                            if (!empty($r->id)) {
                                echo '<tr class="clickable-row" id="' . $r->getAanvraag->aanvraag_nr . '" naam ="' . $r->getAanvraag->aanvraag_nr . '" check="' . $r->id . '" ">
                    <td>' . $count . '</td>
        ...
        $(document).ready(function () {
            $('#mainTable tr').click(function (event) {
                ...
                if (!attr) {
                    ...
                    $('.inputNew').attr('href', "apps/<?php echo app_name;?>/modals/shipper_inbox.php?action=new&id=" + $(this).attr('id'));
                    ...
                    $('.inputDisabled').attr('href', "apps/<?php echo app_name;?>/modals/shipper_inbox.php?action=update&id=" + $(this).attr('id'));
                }


                $('.inputDisabledDelete').prop("disabled", false); // Element(s) are now enabled.
                $('.inputDisabledDelete').attr('data-href', "apps/<?php echo app_name;?>/shipper_inbox.php?action=delete&id=" + $(this).attr('id'));
