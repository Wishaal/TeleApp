    ...
    <section class="content">
        <div class="nav-tabs-custom animated bounceInRight">
            <ul class="nav nav-tabs ">
                ...
                <li class="pull-left header"><i class="fa fa-th"></i> Binnenlandse Aanvragen</li>
            </ul>
...
//                    $('.inputNew').attr('href', "apps/<?php //echo app_name;?>///modals/binnenland_inbehandeling_verwerking.php?action=update&id=" + $(this).attr('id'));
//
...
//                    $('.inputNew').prop("disabled", true); // Element(s) are now enabled.
                ...
                $('.inputDisabled').attr('href', "apps/<?php echo app_name;?>/modals/binnenland_inbehandeling_verwerking.php?action=update&id=" + $(this).attr('id'));
                // }


                $('.inputDisabledDelete').prop("disabled", false); // Element(s) are now enabled.
                $('.inputDisabledDelete').attr('data-href', "apps/<?php echo app_name;?>/binnenlandinbox.php?action=delete&id=" + $(this).attr('id'));
