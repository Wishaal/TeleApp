...
private static $_localeLanguage = 'en_us';
	...
	private static $functionReplaceFromLocale	= null;					//	US English	(default locale)
	 ...
	 *
	 */
	private $debugLogStack = array();	//	function __construct()
	private $_cyclicFormulaCount = 0;
	private $_cyclicFormulaCell = '';	//	function getInstance()
	private $_savedPrecision	= 12;	//	function flushInstance()
