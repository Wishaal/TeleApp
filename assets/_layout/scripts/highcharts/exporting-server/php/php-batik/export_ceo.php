...
// Options
define ('BATIK_PATH', '../../../../../../../php/batik-1.7.1/batik-rasterizer.jar');
...
$outfile = "temp/markaandeelcijfer-".date("Y-m-d").".$ext";
...
if (isset($typeString)) {
	...
	$mail->Host       = "telsur08.mail.telesur.sr";
	//Set the SMTP port number - likely to be 25, 465 or 587
	$mail->Port       = 25;
	//Whether to use SMTP authentication
	$mail->SMTPAuth   = false;
	//Set who the message is to be sent from
	$mail->SetFrom('teleapp@telesur.sr', 'Telesur');
	//Set who the message is to be sent to
	$mail->AddAddress("billey.best@telesur.sr");
	$mail->AddCC("wishaal.mathoera@telesur.sr");
	//Set the subject line
	$mail->Subject = 'Marktaandeel PIE Rapport';
	//Read an HTML message body from an external file, convert referenced images to embedded, convert HTML into a basic plain-text alternative body
	$mail->MsgHTML("Beste,<p>Aangehecht het Marktaandeel PIE Rapport</p><p>Vriendelijke groeten,<br> TeleApp</p>");
	...
	if(!$mail->Send()) {
	  ...
	  //header('Location: data_email64a.php?msg=sent');
	}
